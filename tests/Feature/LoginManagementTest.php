...
class LoginManagementTest extends TestCase
{
     ...
     * @test
     */
    public function a_user_can_connect()
    {
        /**
         * Create a user
         */
    ...
    public function invalid_login_credentials()
    {
        ...
        /**
         * we test the status after try to connect user we may have a status 401
         */
     ...
     * @test
     */
    public function verify_you_email()
    {
        /**
         * Create a user
         */
        $user = User::factory()->create(array_merge($this->data(),['email_verified_at' => null]));
